...
class TaskDetail extends Component {
    ...
    render() {
        if (!this.props.task && !this.state.adding) {
            return (<div>
              <button className="btn" onClick={this.handleAdd}>添加任务</button>
              <hr />
              请选择任务...
              </div>);
        }
        if(!this.state.editing && !this.state.adding){
          if(this.props.task.done){
            return (
              <div>
              <button className="btn" onClick={this.handleEdit}>编辑</button>&nbsp;
              <button className="btn" onClick={() => this.props.deleteTask(this.props.task)}>删除</button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <button className="btn" onClick={this.handleAdd}>添加任务</button>
              <hr />
              <h3>主题: {this.props.task.title}</h3>
              <hr />
              <table className='table'>
              <tbody>
              <tr><th>完成任务最后期限</th><th>{this.props.task.deadline}</th></tr>
              <tr><th>创建日期</th><th>{this.props.task.created_at}</th></tr>
              <tr><th>重要度</th><th>{this.props.task.priority}</th></tr>
              <tr><th>状态</th><th>Done</th></tr>
              <tr><th>细节</th><th>{this.props.task.text}</th></tr>
              </tbody>
              </table>
              </div>
            );
            ...
            return (
              <div>
              <button className="btn" onClick={this.handleDone}>完成</button>&nbsp;
              <button className="btn" onClick={this.handleEdit}>编辑</button>&nbsp;
              <button className="btn" onClick={() => this.props.deleteTask(this.props.task)}>删除</button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <button className="btn" onClick={this.handleAdd}>添加任务</button>
              ...
              <table className='table'>
              <tbody>
              <tr><th>完成最后期限</th><th>{this.props.task.deadline}</th></tr>
              <tr><th>创建日期</th><th>{this.props.task.created_at}</th></tr>
              <tr><th>重要度</th><th>{this.props.task.priority}</th></tr>
              <tr><th>状态</th><th>Doing</th></tr>
              <tr><th>细节</th><th>{this.props.task.text}</th></tr>
              </tbody>
              </table>
              </div>
          ...
          return(
            ...
            <FormGroup>
              ...
              <br />
              <ControlLabel>完成最后期限</ControlLabel>
              ...
              <br />
              <button className='btn' onClick={this.handleAddDone}>添加</button>&nbsp;
              <button className='btn' onClick={this.handleQuit}>退出</button>
            </FormGroup>
            </form>
          );
